...
road.prototype.updateSpeedPositions=function(rType){
  ...
  for(var i=0; i<this.veh.length; i++){
	...
	textarea_cars.push(a+","+rType+","+this.veh[i].id+","+Math.round(3.6*this.veh[i].speed)+","+this.veh[i].lane+","+this.veh[i].u.toFixed(5)+"\n");
	 
	this.textarea.push("\nTime: "+ a+ " rType: "+rType +" id: "+ this.veh[i].id + "Speed: "+ Math.round(3.6*this.veh[i].speed) + " lane:" + this.veh[i].lane + " u:"+this.veh[i].u.toFixed(3));
